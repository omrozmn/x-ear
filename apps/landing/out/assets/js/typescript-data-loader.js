...
const globalLoadedModules = new Set();
    ...
    scripts.forEach((scriptPath, index) => {
        ...
        import(scriptPath).then(module => {
            ...
            if (loadedCount === totalScripts) {
                ...
                initializeServices(moduleRegistry);
            }
        }).catch(error => {
