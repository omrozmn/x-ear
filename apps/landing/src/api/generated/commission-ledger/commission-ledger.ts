...
export const createCommissionCreate = (
 ...
 signal?: AbortSignal
      ...
      {url: `/api/api/commissions/create`, method: 'POST',
...
export const createCommissionUpdateStatus = (
 ...
 signal?: AbortSignal
      ...
      return customInstance<unknown>(
      {url: `/api/api/commissions/update-status`, method: 'POST',
        params, signal
    },
      );
    }
...
export const listCommissionByAffiliate = (
 ...
 signal?: AbortSignal
      ...
      return customInstance<unknown>(
      {url: `/api/api/commissions/by-affiliate`, method: 'GET',
        params, signal
    },
      );
    }
...
export const getListCommissionByAffiliateQueryKey = (params?: ListCommissionByAffiliateParams,) => {
    return [
    `/api/api/commissions/by-affiliate`, ...(params ? [params]: [])
    ] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListCommissionByAffiliateQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listCommissionByAffiliate>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useListCommissionByAffiliate<TData = Awaited<ReturnType<typeof listCommissionByAffiliate>>, TError = HTTPValidationError>(
 params: undefined |  ListCommissionByAffiliateParams, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof listCommissionByAffiliate>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export const listCommissionAudit = (
 ...
 signal?: AbortSignal
      ...
      return customInstance<unknown>(
      {url: `/api/api/commissions/audit`, method: 'GET',
        params, signal
    },
      );
    }
...
export const getListCommissionAuditQueryKey = (params?: ListCommissionAuditParams,) => {
    return [
    `/api/api/commissions/audit`, ...(params ? [params]: [])
    ] as const;
    }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListCommissionAuditQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listCommissionAudit>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useListCommissionAudit<TData = Awaited<ReturnType<typeof listCommissionAudit>>, TError = HTTPValidationError>(
 params: undefined |  ListCommissionAuditParams, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof listCommissionAudit>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
