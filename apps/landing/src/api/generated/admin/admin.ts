...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListAdminDebugAvailableRolesQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listAdminDebugAvailableRoles>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetAdminDebugPagePermissionQueryKey(pageKey);
   ...
   return  { queryKey, queryFn, enabled: !!(pageKey), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getAdminDebugPagePermission>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
