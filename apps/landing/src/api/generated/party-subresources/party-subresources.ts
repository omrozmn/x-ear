...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetPartyHearingTestQueryKey(partyId,testId);
   ...
   return  { queryKey, queryFn, enabled: !!(partyId && testId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPartyHearingTest>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetDeviceRecommendationsQueryKey(partyId,testId);
   ...
   return  { queryKey, queryFn, enabled: !!(partyId && testId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getDeviceRecommendations>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetRemTargetsQueryKey(partyId,testId,params);
   ...
   return  { queryKey, queryFn, enabled: !!(partyId && testId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getRemTargets>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetRemMeasurementQueryKey(partyId,testId);
   ...
   return  { queryKey, queryFn, enabled: !!(partyId && testId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getRemMeasurement>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetPartyAnamnesisQueryKey(partyId);
   ...
   return  { queryKey, queryFn, enabled: !!(partyId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getPartyAnamnesis>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
