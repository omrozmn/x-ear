...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListAdminIntegrationsQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listAdminIntegrations>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListAdminIntegrationVatanSmConfigQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listAdminIntegrationVatanSmConfig>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListAdminIntegrationBirfaturaConfigQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listAdminIntegrationBirfaturaConfig>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
 ...
 */
export const listAdminIntegrationTelegramConfig = (
 ...
 signal?: AbortSignal
      ...
      return customInstance<IntegrationDetailResponse>(
      {url: `/api/admin/integrations/telegram/config`, method: 'GET', signal
    },
      );
    }
...
export const getListAdminIntegrationTelegramConfigQueryKey = () => {
    return [
    `/api/admin/integrations/telegram/config`
    ] as const;
    }

    
export const getListAdminIntegrationTelegramConfigQueryOptions = <TData = Awaited<ReturnType<typeof listAdminIntegrationTelegramConfig>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listAdminIntegrationTelegramConfig>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getListAdminIntegrationTelegramConfigQueryKey();

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof listAdminIntegrationTelegramConfig>>> = ({ signal }) => listAdminIntegrationTelegramConfig(signal);

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listAdminIntegrationTelegramConfig>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type ListAdminIntegrationTelegramConfigQueryResult = NonNullable<Awaited<ReturnType<typeof listAdminIntegrationTelegramConfig>>>
export type ListAdminIntegrationTelegramConfigQueryError = unknown


export function useListAdminIntegrationTelegramConfig<TData = Awaited<ReturnType<typeof listAdminIntegrationTelegramConfig>>, TError = unknown>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof listAdminIntegrationTelegramConfig>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof listAdminIntegrationTelegramConfig>>,
          TError,
          Awaited<ReturnType<typeof listAdminIntegrationTelegramConfig>>
        > , 'initialData'
      >, }
...
export function useListAdminIntegrationTelegramConfig<TData = Awaited<ReturnType<typeof listAdminIntegrationTelegramConfig>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof listAdminIntegrationTelegramConfig>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get Telegram Config
...
export function useListAdminIntegrationTelegramConfig<TData = Awaited<ReturnType<typeof listAdminIntegrationTelegramConfig>>, TError = unknown>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getListAdminIntegrationTelegramConfigQueryOptions(options)
 ...
 */
export const updateAdminIntegrationTelegramConfig = (
    telegramConfigUpdate: TelegramConfigUpdate,
 ) => {
      
      
      return customInstance<SchemasBaseResponseEnvelope>(
      {url: `/api/admin/integrations/telegram/config`, method: 'PUT',
      headers: {'Content-Type': 'application/json', },
...
export const getUpdateAdminIntegrationTelegramConfigMutationOptions = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateAdminIntegrationTelegramConfig>>, TError,{data: TelegramConfigUpdate}, TContext>, }
): UseMutationOptions<Awaited<ReturnType<typeof updateAdminIntegrationTelegramConfig>>, TError,{data: TelegramConfigUpdate}, TContext> => {

const mutationKey = ['updateAdminIntegrationTelegramConfig'];
const {mutation: mutationOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateAdminIntegrationTelegramConfig>>, {data: TelegramConfigUpdate}> = (props) => {
          const {data} = props ?? {};

          return  updateAdminIntegrationTelegramConfig(data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateAdminIntegrationTelegramConfigMutationResult = NonNullable<Awaited<ReturnType<typeof updateAdminIntegrationTelegramConfig>>>
    export type UpdateAdminIntegrationTelegramConfigMutationBody = TelegramConfigUpdate
    export type UpdateAdminIntegrationTelegramConfigMutationError = HTTPValidationError

    /**
 * @summary Update Telegram Config
 */
export const useUpdateAdminIntegrationTelegramConfig = <TError = HTTPValidationError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateAdminIntegrationTelegramConfig>>, TError,{data: TelegramConfigUpdate}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
        Awaited<ReturnType<typeof updateAdminIntegrationTelegramConfig>>,
        TError,
        {data: TelegramConfigUpdate},
        TContext
      > => {

      const mutationOptions = getUpdateAdminIntegrationTelegramConfigMutationOptions(options);
