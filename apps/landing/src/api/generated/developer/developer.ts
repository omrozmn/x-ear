...
export const listDeveloperSchemaRegistry = (
 ...
 signal?: AbortSignal
      ...
      return customInstance<ResponseEnvelopeSchemaRegistryResponse>(
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListDeveloperSchemaRegistryQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listDeveloperSchemaRegistry>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
