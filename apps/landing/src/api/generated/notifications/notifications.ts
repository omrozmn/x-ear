...
export function useListNotificationStats<TData = Awaited<ReturnType<typeof listNotificationStats>>, TError = HTTPValidationError>(
 params: undefined |  ListNotificationStatsParams, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof listNotificationStats>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useListNotificationSettings<TData = Awaited<ReturnType<typeof listNotificationSettings>>, TError = HTTPValidationError>(
 params: undefined |  ListNotificationSettingsParams, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof listNotificationSettings>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
