...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListPatientReplacementsQueryKey(patientId);
   ...
   return  { queryKey, queryFn, enabled: !!(patientId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listPatientReplacements>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetReplacementQueryKey(replacementId);
   ...
   return  { queryKey, queryFn, enabled: !!(replacementId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getReplacement>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
