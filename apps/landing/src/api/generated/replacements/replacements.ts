...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListPatientReplacementsQueryKey(partyId);
   ...
   return  { queryKey, queryFn, enabled: !!(partyId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listPatientReplacements>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
