...
export const getEmailLogs = (
 ...
 signal?: AbortSignal
      ...
      return customInstance<ResponseEnvelopeEmailLogListResponse>(
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetEmailLogsQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getEmailLogs>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const sendManualEmail = (
 ...
 signal?: AbortSignal
      ...
      return customInstance<ResponseEnvelopeSendEmailResponse>(
