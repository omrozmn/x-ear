...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAutocompleteApiAiComposerAutocompleteGetQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof autocompleteApiAiComposerAutocompleteGet>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const analyzeDocumentsApiAiComposerAnalyzePost = (
 ...
 signal?: AbortSignal
      ...
      return customInstance<AnalyzeResponse>(
