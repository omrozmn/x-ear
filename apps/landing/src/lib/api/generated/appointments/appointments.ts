...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAppointmentsListAppointmentsQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof appointmentsListAppointments>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const getAppointmentsCreateAppointmentMutationOptions = <TError = ErrorResponse | ErrorResponse | ErrorResponse,
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type AppointmentsCreateAppointmentMutationError = ErrorResponse | ErrorResponse | ErrorResponse

    /**
 * @summary Create a new appointment
 */
export const useAppointmentsCreateAppointment = <TError = ErrorResponse | ErrorResponse | ErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof appointmentsCreateAppointment>>, TError,{data: AppointmentsCreateAppointmentBody}, TContext>, }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAppointmentsGetAvailabilityQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof appointmentsGetAvailability>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getAppointmentsGetAppointmentsQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof appointmentsGetAppointments>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
