...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getProformasGetProformaQueryKey(proformaId);
   ...
   return  { queryKey, queryFn, enabled: !!(proformaId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof proformasGetProforma>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
