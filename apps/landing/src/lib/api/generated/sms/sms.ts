...
export const getSmsGetHeadersQueryOptions = <TData = Awaited<ReturnType<typeof smsGetHeaders>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof smsGetHeaders>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getSmsGetHeadersQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof smsGetHeaders>>> = ({ signal }) => smsGetHeaders(signal);

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof smsGetHeaders>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useSmsGetHeaders<TData = Awaited<ReturnType<typeof smsGetHeaders>>, TError = unknown>(
...
export function useSmsGetHeaders<TData = Awaited<ReturnType<typeof smsGetHeaders>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof smsGetHeaders>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get SMS headers
...
export const getSmsGetAudiencesQueryOptions = <TData = Awaited<ReturnType<typeof smsGetAudiences>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof smsGetAudiences>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getSmsGetAudiencesQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof smsGetAudiences>>> = ({ signal }) => smsGetAudiences(signal);

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof smsGetAudiences>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useSmsGetAudiences<TData = Awaited<ReturnType<typeof smsGetAudiences>>, TError = unknown>(
...
export function useSmsGetAudiences<TData = Awaited<ReturnType<typeof smsGetAudiences>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof smsGetAudiences>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get SMS audiences
...
export const getSmsGetConfigQueryOptions = <TData = Awaited<ReturnType<typeof smsGetConfig>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof smsGetConfig>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getSmsGetConfigQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof smsGetConfig>>> = ({ signal }) => smsGetConfig(signal);

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof smsGetConfig>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useSmsGetConfig<TData = Awaited<ReturnType<typeof smsGetConfig>>, TError = unknown>(
...
export function useSmsGetConfig<TData = Awaited<ReturnType<typeof smsGetConfig>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof smsGetConfig>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary Get SMS configuration
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getSmsIntegrationGetSmsPackagesQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof smsIntegrationGetSmsPackages>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getSmsIntegrationGetSmsCreditQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof smsIntegrationGetSmsCredit>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getSmsDownloadDocumentQueryKey(documentType);
   ...
   return  { queryKey, queryFn, enabled: !!(documentType), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof smsDownloadDocument>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getSmsMonitoringQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof smsMonitoring>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getSmsIntegrationDownloadSmsDocumentQueryKey(documentType);
   ...
   return  { queryKey, queryFn, enabled: !!(documentType), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof smsIntegrationDownloadSmsDocument>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
