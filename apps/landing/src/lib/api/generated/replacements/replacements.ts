...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getReplacementsGetReplacementQueryKey(replacementId);
   ...
   return  { queryKey, queryFn, enabled: !!(replacementId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof replacementsGetReplacement>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
