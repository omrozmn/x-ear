...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getTenantUsersServeTenantAssetQueryKey(tenantId,filename);
   ...
   return  { queryKey, queryFn, enabled: !!(tenantId && filename), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof tenantUsersServeTenantAsset>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
