...
export const getInventoryGetInventoryItemsQueryOptions = <TData = Awaited<ReturnType<typeof inventoryGetInventoryItems>>, TError = ErrorResponse | ErrorResponse>(params?: InventoryGetInventoryItemsParams, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof inventoryGetInventoryItems>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getInventoryGetInventoryItemsQueryKey(params);
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof inventoryGetInventoryItems>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type InventoryGetInventoryItemsQueryResult = NonNullable<Awaited<ReturnType<typeof inventoryGetInventoryItems>>>
export type InventoryGetInventoryItemsQueryError = ErrorResponse | ErrorResponse


export function useInventoryGetInventoryItems<TData = Awaited<ReturnType<typeof inventoryGetInventoryItems>>, TError = ErrorResponse | ErrorResponse>(
...
export const getInventoryGetInventoryItemQueryOptions = <TData = Awaited<ReturnType<typeof inventoryGetInventoryItem>>, TError = ErrorResponse | ErrorResponse>(itemId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof inventoryGetInventoryItem>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getInventoryGetInventoryItemQueryKey(itemId);
   ...
   return  { queryKey, queryFn, enabled: !!(itemId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof inventoryGetInventoryItem>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useInventoryGetInventoryItem<TData = Awaited<ReturnType<typeof inventoryGetInventoryItem>>, TError = ErrorResponse | ErrorResponse>(
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getInventoryGetInventoryActivitiesQueryKey(itemId);
   ...
   return  { queryKey, queryFn, enabled: !!(itemId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof inventoryGetInventoryActivities>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getInventoryGetLowStockItemsQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof inventoryGetLowStockItems>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getInventoryGetInventoryStatsQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof inventoryGetInventoryStats>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const getInventoryCreateCategoryMutationOptions = <TError = ErrorResponse | ErrorResponse | ErrorResponse,
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type InventoryCreateCategoryMutationError = ErrorResponse | ErrorResponse | ErrorResponse

    /**
 * @summary Create new inventory category
 */
export const useInventoryCreateCategory = <TError = ErrorResponse | ErrorResponse | ErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof inventoryCreateCategory>>, TError,{data: InventoryCreateCategoryBody}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getInventoryGetBrandsQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof inventoryGetBrands>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getInventoryGetBrandsOldQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof inventoryGetBrandsOld>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getInventoryGetInventoryMovementsQueryKey(itemId);
   ...
   return  { queryKey, queryFn, enabled: !!(itemId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof inventoryGetInventoryMovements>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getInventoryGetCategoriesOldQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof inventoryGetCategoriesOld>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getInventoryGetUnitsQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof inventoryGetUnits>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getInventoryGetFeaturesQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof inventoryGetFeatures>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getInventoryAdvancedSearchQueryKey();
   ...
   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof inventoryAdvancedSearch>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
