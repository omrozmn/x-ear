 ...
 */
export type inventoryGetInventoryItemResponse200 = {
  data: InventoryGetInventoryItem200
  status: 200
}

export type inventoryGetInventoryItemResponse404 = {
  data: ErrorResponse
  status: 404
}

export type inventoryGetInventoryItemResponse500 = {
  data: ErrorResponse
  status: 500
}
    
export type inventoryGetInventoryItemResponseSuccess = (inventoryGetInventoryItemResponse200) & {
  headers: Headers;
};
export type inventoryGetInventoryItemResponseError = (inventoryGetInventoryItemResponse404 | inventoryGetInventoryItemResponse500) & {
  headers: Headers;
};

export type inventoryGetInventoryItemResponse = (inventoryGetInventoryItemResponseSuccess | inventoryGetInventoryItemResponseError)

export const getInventoryGetInventoryItemUrl = (itemId: string,) => {
...
export const inventoryGetInventoryItem = async (itemId: string, options?: RequestInit): Promise<inventoryGetInventoryItemResponse> => {
  
  const res = await fetch(getInventoryGetInventoryItemUrl(itemId),
  {      
    ...options,
    method: 'GET'
  ...
  const data: inventoryGetInventoryItemResponse['data'] = body ? JSON.parse(body) : {}
  return { data, status: res.status, headers: res.headers } as inventoryGetInventoryItemResponse
}
