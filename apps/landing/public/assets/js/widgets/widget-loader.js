    ...
    injectPageStructure(activePage, pageTitle, mainContent) {
        return `
            ...
            <body class="bg-light-gray">
                ...
                <script src="../assets/js/notifications/notification-client.js"></script>
                <script>
                    // Use existing global widget loader instance
                    window.widgetLoader.initPageWidgets('${activePage}');
                </script>
                <script>
                    // Apply initial collapsed state early so layout CSS applies before the main content is rendered
                    (function(){
                        try {
