...
class DeviceRegistry(BaseModel, TenantScopedMixin):
    ...
    def to_dict(self):
        return {
            ...
            "status": self.status,
            "lastSeenAt": format_datetime_utc(self.last_seen_at),
            "calibrationDate": format_datetime_utc(self.calibration_date),
            "nextCalibrationDate": format_datetime_utc(self.next_calibration_date),
            "warrantyExpiry": format_datetime_utc(self.warranty_expiry),
            "notes": self.notes,
