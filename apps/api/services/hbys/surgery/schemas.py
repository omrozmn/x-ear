"""
Pydantic v2 schemas for the Surgery Service (MS-8).
"""
...
class ChecklistPhaseRead(AppBaseModel):
    patient_identity_confirmed: Optional[bool] = None
    site_marked: Optional[bool] = None
    anesthesia_check_complete: Optional[bool] = None
    pulse_oximeter_on: Optional[bool] = None
    allergies_checked: Optional[bool] = None
    airway_risk_assessed: Optional[bool] = None
    team_introduction: Optional[bool] = None
    patient_procedure_site_confirmed: Optional[bool] = None
    antibiotic_prophylaxis_given: Optional[bool] = None
    critical_events_reviewed: Optional[bool] = None
    imaging_displayed: Optional[bool] = None
    procedure_recorded: Optional[bool] = None
    instrument_count_correct: Optional[bool] = None
    specimens_labeled: Optional[bool] = None
    concerns_addressed: Optional[bool] = None
