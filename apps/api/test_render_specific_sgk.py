...
if __name__ == '__main__':
    ...
    invoice_data = {
        ...
        'mukellef_adi': 'ÖZMEN TIBBİ CİHAZLAR İÇ VE DIŞ TİCARET LTD ŞTİ', # Using sender name as taxpayer name usually, or if it's "Medula Tesis Adı"
        'period_start': '2026-01-01',
        'period_end': '2026-01-31',
        
        'supplier': {
            'name': 'ÖZMEN TIBBİ CİHAZLAR İÇ VE DIŞ TİCARET LTD ŞTİ',
            'tax_id': '7030734275',
