                ...
                >
                  ...
                  {message.intent && (
                    <div className={`mt-2 pt-2 border-t ${
                      message.role === 'user' ? 'border-primary-500' : 'border-gray-300'
                    } text-xs opacity-75`}>
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex items-end space-x-2">
              <textarea
                ...
                disabled={isLoading}
                rows={1}
                className="flex-1 resize-none border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 disabled:opacity-50 disabled:cursor-not-allowed"
