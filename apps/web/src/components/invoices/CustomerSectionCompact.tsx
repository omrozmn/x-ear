...
export function CustomerSectionCompact({
  ...
  const handlePatientSelect = useCallback((patient: Patient) => {
    ...
    // Adres bilgilerini çek - Patient tipindeki alan isimleri farklı olabilir
    ...
    addressText = (patient.addressFull as string) || (patient.address_full as string) || '';
    cityValue = (patient.addressCity as string) || (patient.address_city as string) || '';
    districtValue = (patient.addressDistrict as string) || (patient.address_district as string) || '';

    // Fallbacks: some records may have nested address object or separate street field
    if (!addressText && (patient as any).address) {
      const a = (patient as any).address;
