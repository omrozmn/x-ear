...
export const DeviceTrialModal: React.FC<DeviceTrialModalProps> = ({
    ...
    try {
      ...
      if (trialData.status === 'completed' || trialData.status === 'cancelled') {
        try {
          ...
          await timelineService.addDeviceEvent(patientId, eventType, {
  ...
  const handleAddExtension = async () => {
    ...
    try {
      await timelineService.addDeviceEvent(patientId, 'device_trial_extended', {
                  ...
                  <div>
                    ...
                    <Select
                      ...
                      options={[
                        ...
                        { value: 'patient_request', label: 'Hasta Talebi' },
