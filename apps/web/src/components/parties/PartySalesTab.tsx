    ...
    () =>
      filteredSales.map((sale) => {
        ...
        return {
          ...
          actualListPriceTotal: (sale as any).actualListPriceTotal ?? sale.listPriceTotal ?? undefined,
          totalAmount: sale.totalAmount ?? 0,
          discountAmount: sale.discountAmount ?? 0,
          finalAmount: sale.finalAmount ?? sale.totalAmount ?? 0,
          paidAmount: sale.paidAmount ?? 0,
          paymentStatus: ((sale as any).paymentStatus ?? 'pending') as PartySale['paymentStatus'],
          paymentMethod: sale.paymentMethod ?? undefined,
          soldBy: normalizedSale.soldBy ?? undefined,
          sgkScheme: (sale as any).sgkScheme ?? undefined,
