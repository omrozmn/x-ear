      ...
      <CardContent className="space-y-4">
        ...
        <div className="relative">
          <div className="relative">
            <Input
              ...
              className="pl-10 pr-4 py-2 w-full border border-border rounded-2xl focus:ring-2 focus:ring-ring focus:border-transparent"
            />
                    ...
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4 mt-1">
                          ...
                          <span className="text-xs text-primary font-medium">KDV: %{product.vatRate}</span>
                        </div>
                      </div>
        ...
        {selectedProduct && (
          <div className="p-4 bg-success/10 border border-green-200 rounded-2xl">
            <div className="flex justify-between items-start">
              <div className="flex-1">
                <div className="font-medium text-success">{selectedProduct.name}</div>
              ...
              <div className="text-right">
                ...
                {selectedProduct.listPrice > selectedProduct.salePrice && (
                  <div className="text-sm text-success line-through">
