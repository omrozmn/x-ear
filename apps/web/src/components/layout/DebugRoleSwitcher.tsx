...
import { useAdminDebugGetAvailableRoles, useAdminDebugSwitchRole } from '../../api/generated/xEarCRMAPIAutoGenerated';
...
export const DebugRoleSwitcher: React.FC<DebugRoleSwitcherProps> = ({ darkMode = false }) => {
  ...
  const { data: rolesResponse, isLoading: rolesLoading } = useAdminDebugGetAvailableRoles({
    query: {
