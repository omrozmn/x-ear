...
export const ReturnExchangeModal: React.FC<ReturnExchangeModalProps> = ({
        ...
        <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
          <div className="p-6">
            <div className="flex items-center justify-between border-b pb-4 mb-6">
              <div>
                <h2 className="text-2xl font-bold text-gray-900">Yeni Ürün Seçimi</h2>
                <p className="text-gray-600 mt-1">Değişim yapılacak ürünü seçin</p>
              </div>
              <Button
  ...
  if (showInvoicePreview && previewInvoiceData) {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
          <div className="p-6">
            <div className="flex items-center justify-between border-b pb-4 mb-6">
              <div>
                <h2 className="text-2xl font-bold text-gray-900">İade Faturası Önizleme</h2>
                <p className="text-gray-600 mt-1">Fatura #{previewInvoiceData.invoiceNumber}</p>
              </div>
              <Button
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <h3 className="text-sm font-medium text-gray-900 mb-2">Tedarikçi Bilgileri</h3>
                    <p className="text-sm text-gray-600">{previewInvoiceData.supplierName}</p>
                    <p className="text-sm text-gray-600">İade Faturası: {previewInvoiceData.supplierInvoiceNumber}</p>
                  </div>
                  <div>
                    <h3 className="text-sm font-medium text-gray-900 mb-2">Fatura Bilgileri</h3>
                    <p className="text-sm text-gray-600">Tarih: {new Date(previewInvoiceData.createdAt).toLocaleDateString('tr-TR')}</p>
                    <p className="text-sm text-gray-600">Durum: {previewInvoiceData.status === 'gib_sent' ? 'GİB\'e Gönderildi' : 'Taslak'}</p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex justify-end">
                  <div className="text-right">
                    ...
                    <p className="text-2xl font-bold text-gray-900">
                      {previewInvoiceData.amount.toLocaleString('tr-TR')} ₺
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex justify-end space-x-4 pt-6 border-t">
                ...
                {previewInvoiceData.status !== 'gib_sent' && (
                  <Button
                    className="bg-green-600 hover:bg-green-700"
                    onClick={() => {
                      if (returnInvoice) {
                        sendInvoiceToGib(returnInvoice.id);
