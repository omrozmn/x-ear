...
// API imports
import { sgkGetPatientSgkDocuments, sgkUploadSgkDocument, sgkDeleteSgkDocument, sgkProcessOcr, automationTriggerSgkProcessing } from '../../api/generated/xEarCRMAPIAutoGenerated';
