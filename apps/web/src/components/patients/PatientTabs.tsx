...
export const PatientTabs: React.FC<PatientTabsProps> = ({
  ...
  const tabs = [
    {
      id: 'general' as PatientTab,
      label: 'Genel Bilgiler',
      icon: <User className="w-4 h-4" />,
      count: null,
    },
    {
      id: 'devices' as PatientTab,
      label: 'Cihazlar',
      icon: <Headphones className="w-4 h-4" />,
      count: patient.devices?.length || 0,
    },
    {
      id: 'sales' as PatientTab,
      label: 'Satışlar',
      icon: <CreditCard className="w-4 h-4" />,
      count: patient.installments?.length || 0,
    },
    {
      id: 'sgk' as PatientTab,
      label: 'SGK İşlemleri',
    ...
    {
      id: 'documents' as PatientTab,
      label: 'Belgeler',
      icon: <FileText className="w-4 h-4" />,
      count: patient.reports?.length || 0,
    },
    {
      id: 'timeline' as PatientTab,
      label: 'Zaman Çizelgesi',
      icon: <Clock className="w-4 h-4" />,
      count: null,
    },
    {
      id: 'notes' as PatientTab,
      label: 'Notlar',
      icon: <StickyNote className="w-4 h-4" />,
      count: patient.notes?.length || 0,
    },
    {
      id: 'appointments' as PatientTab,
      label: 'Randevular',
  ...
  return (
    <Tabs value={activeTab} onValueChange={(value) => onTabChange(value as PatientTab)} className="w-full">
