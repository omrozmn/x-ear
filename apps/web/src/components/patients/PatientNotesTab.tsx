...
export const PatientNotesTab: React.FC<PatientNotesTabProps> = ({ patient, onPatientUpdate }) => {
  ...
  const { timelineGetPatientTimeline, timelineAddTimelineEvent } = getTimeline();
  const { patientSubresourcesCreatePatientNote, patientSubresourcesDeletePatientNote } = getPatients();
