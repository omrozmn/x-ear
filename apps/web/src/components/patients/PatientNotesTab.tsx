...
export const PatientNotesTab: React.FC<PatientNotesTabProps> = ({ patient, onPatientUpdate }) => {
  ...
  const api = React.useMemo(() => getXEarCRMAPIAutoGenerated(), []);
  const { timelineGetPatientTimeline, timelineAddTimelineEvent, patientSubresourcesCreatePatientNote, patientSubresourcesDeletePatientNote } = api;
