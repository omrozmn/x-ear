          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="text-purple-700 dark:text-purple-300">{patientRightsData.patientName}</p>
              </div>
              <div>
                <span className="font-medium text-purple-800 dark:text-purple-200">SGK No:</span>
                <p className="text-purple-700 dark:text-purple-300">{patientRightsData.sgkNo}</p>
              </div>
              <div>
                <span className="font-medium text-purple-800 dark:text-purple-200">Geçerlilik:</span>
                <p className="text-purple-700 dark:text-purple-300">{patientRightsData.validityPeriod.startDate} - {patientRightsData.validityPeriod.endDate}</p>
              </div>
              <div>
                <span className="font-medium text-purple-800 dark:text-purple-200">Kalan Gün:</span>
                <p className="text-purple-700 dark:text-purple-300">{patientRightsData.validityPeriod.remainingDays} gün</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="text-lg font-semibold text-green-900 dark:text-green-100">₺{patientRightsData.totalUsed}</p>
              </div>
              <div>
                <span className="text-green-700 dark:text-green-300">Toplam Kalan:</span>
                <p className="text-lg font-semibold text-green-900 dark:text-green-100">₺{patientRightsData.totalRemaining}</p>
              </div>
            </div>
          </div>
        </div>
