...
import { appointmentsGetAppointments, appointmentsCreateAppointment, appointmentsCancelAppointment, appointmentsCompleteAppointment } from '../../api/generated/xEarCRMAPIAutoGenerated';
import type {
  Appointment,
...
export const PatientAppointmentsTab: React.FC<PatientAppointmentsTabProps> = ({ patient }) => {
  ...
  const loadAppointments = useCallback(async () => {
    ...
    try {
      ...
      const response = await appointmentsGetAppointments(params) as { data?: AppointmentsListAppointments200 };
