...
import { usePatientDevices } from '../../hooks/usePatients';
...
export const PatientDevicesTab: React.FC<PatientDevicesTabProps> = ({ patient, onPatientUpdate }) => {
  ...
  const { data: devices, isLoading: devicesLoading, error: devicesError, refetch: refetchDevices } = usePatientDevices(patient?.id || '');
  ...
  const handleAssignDevice = async (deviceData: Record<string, unknown>) => {
    try {
      ...
      if (deviceData.mode === 'inventory') {
        ...
        await api.inventoryAssignToPatient(deviceData.inventoryId as string, assignData);
      } else {
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2">
                    <input type="checkbox" name="rightEarEnabled" id="rightEarEnabled" defaultChecked data-allow-raw="true" />
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2">
                    <input type="checkbox" name="leftEarEnabled" id="leftEarEnabled" data-allow-raw="true" />
