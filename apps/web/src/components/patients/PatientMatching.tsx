                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-3">
                      {match.patients.map((patient, index) => (
                        <div key={patient.id} className="border dark:border-gray-700 rounded-lg p-3 dark:bg-gray-700/30">
                          <div className="flex items-center space-x-2 mb-2">
                            <User className="w-4 h-4 text-gray-500 dark:text-gray-400" />
                            <span className="font-medium dark:text-white">{patient.firstName} {patient.lastName}</span>
                          </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                {selectedMatch.patients.map((patient, index) => (
                  <div key={patient.id} className="border dark:border-gray-700 rounded-lg p-3 dark:bg-gray-800">
                    <h5 className="font-medium mb-2 dark:text-white">Hasta {index + 1}: {patient.firstName} {patient.lastName}</h5>
            ...
            <div>
              ...
              <div className="space-y-2">
                {mergePreview.duplicates.map(patient => (
                  <div key={patient.id} className="border border-red-200 dark:border-red-800 rounded-lg p-3 bg-red-50 dark:bg-red-900/20">
                    <div className="font-medium dark:text-red-300">{patient.firstName} {patient.lastName}</div>
                    <div className="text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <div className="space-y-1 mt-1">
                        {conflict.values.map((value, valueIndex) => (
                          <div key={valueIndex} className="text-sm dark:text-gray-300">
                            <strong className="dark:text-white">{value.patientName}:</strong> {value.value}
                          </div>
                        ))}
                      </div>
                    </div>
