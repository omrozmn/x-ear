...
export const convertOrvalToLegacyParty = (orvalParty: PartyRead | Record<string, unknown>): Party => {
  ...
  const party: Party = {
    ...
    acquisitionType: (orvalParty.acquisitionType ?? asRecord.acquisition_type ?? undefined) as string | undefined,
    conversionStep: (orvalParty.conversionStep ?? asRecord.conversion_step ?? undefined) as string | undefined,
    referredBy: (orvalParty.referredBy ?? asRecord.referred_by ?? undefined) as string | undefined,
    priorityScore: (orvalParty.priorityScore ?? asRecord.priority_score ?? undefined) as number | undefined,
    branchId: (orvalParty.branchId ?? asRecord.branch_id ?? undefined) as string | undefined,
    branchName: (orvalParty.branchName ?? asRecord.branch_name ?? undefined) as string | undefined,
    addressCity: (orvalParty.addressCity ?? asRecord.address_city ?? undefined) as string | undefined,
    addressDistrict: (orvalParty.addressDistrict ?? asRecord.address_district ?? undefined) as string | undefined,
    addressFull: (orvalParty.addressFull ?? asRecord.address_full ?? undefined) as string | undefined,
    tenantId: (orvalParty.tenantId ?? asRecord.tenant_id ?? undefined) as string | undefined,
    tags: (asRecord.tags ?? undefined) as string[] | undefined,
    sgkInfo: (asRecord.sgkInfo ?? asRecord.sgk_info ?? undefined) as SGKInfo | undefined,
    roles: (asRecord.roles ?? undefined) as Array<{ code: string; is_primary?: boolean }> | undefined,
    hearingProfile: (asRecord.hearingProfile ?? asRecord.hearing_profile ?? undefined) as HearingProfile | undefined,
