import { Patient as OrvalPatient, PatientStatus } from '../../api/generated/api.schemas';
...
export function convertOrvalToLegacyPatient(orvalPatient: OrvalPatient): LegacyPatient {
  ...
  return {
    ...
    status: (orvalPatient.status === PatientStatus.INACTIVE ? 'inactive' : 'active') as 'active' | 'inactive',
