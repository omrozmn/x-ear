        ...
        },
        {
            ...
            render: (_: unknown, record: ActivityLogRead) => (
                <Button
                    ...
                    title={canViewDetails ? t('detail', 'Detay') : t('detailsHidden', 'Detaylar gizli')}
                >
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl border border-border p-4">
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                    <div>
                        <label className="text-xs font-medium text-muted-foreground mb-1 block">{t('branch', 'Şube')}</label>
                        <Select
                    ...
                    <div>
                        <label className="text-xs font-medium text-muted-foreground mb-1 block">{t('user', 'Kullanıcı')}</label>
                        <Select
                            className="w-full text-sm"
                    ...
                    <div className="md:col-span-2">
                        <label className="text-xs font-medium text-muted-foreground mb-1 block">{t('search', 'Arama')}</label>
                        <Input
                            type="text"
                            className="w-full text-sm"
                            placeholder={t('activitySearchPlaceholder', 'Kullanıcı, mesaj, işlem türü veya kayıt ara...')}
