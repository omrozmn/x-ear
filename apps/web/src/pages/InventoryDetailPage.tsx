...
export const InventoryDetailPage: React.FC<InventoryDetailPageProps> = ({ id }) => {
  ...
  const loadItem = async () => {
    try {
      ...
      const response = await orvalApi.inventoryGetInventoryItem(id);
  ...
  const confirmDelete = async () => {
    ...
    try {
      const orvalApi = getXEarCRMAPIAutoGenerated();
      await orvalApi.inventoryDeleteInventoryItem(id);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const orvalApi = getXEarCRMAPIAutoGenerated();
      const response = await orvalApi.inventoryUpdateInventoryItem(id, {
  ...
  const handleSaveSerials = async (serials: string[]) => {
    ...
    try {
      ...
      const orvalApi = getXEarCRMAPIAutoGenerated();
      const response = await orvalApi.inventoryAddSerialNumbers(id, { serials });
  ...
  const handleFeaturesChange = async (features: string[]) => {
    ...
    try {
      ...
      const orvalApi = getXEarCRMAPIAutoGenerated();
      const response = await orvalApi.inventoryUpdateInventoryItem(id, { features });
