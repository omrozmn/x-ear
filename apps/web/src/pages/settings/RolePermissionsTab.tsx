...
export function RolePermissionsTab() {
  ...
  const { data: allPermissionsResponse, isLoading: loadingPermissions } = usePermissionsListPermissions();
  ...
  const updateMutation = usePermissionsUpdateRolePermissions({
    mutation: {
      onSuccess: () => {
        ...
        // Orval'ın query key formatını kullanarak cache'i temizle
        queryClient.invalidateQueries({ queryKey: getPermissionsGetRolePermissionsQueryKey(selectedRole) });
        queryClient.invalidateQueries({ queryKey: getPermissionsListPermissionsQueryKey() });
        setHasChanges(false);
      },
  ...
  const rolePermissionsData = rolePermissionsResponse?.data as RolePermissionsResponse | undefined;
