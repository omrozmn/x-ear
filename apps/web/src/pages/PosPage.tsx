...
import { usePaytrInitiate, useGetInstallmentOptions } from '../api/generated/xEarCRMAPIAutoGenerated';
...
export default function PosPage() {
    ...
    const { mutate: initiatePayment, isPending } = usePaytrInitiate();
    const { mutate: getInstallments, isPending: loadingInstallments } = useGetInstallmentOptions();
