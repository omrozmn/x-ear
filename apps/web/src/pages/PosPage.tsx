            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <Card className="p-6">
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <div className="p-6 bg-blue-50 rounded-xl border border-blue-100 flex flex-col items-center justify-center">
                                ...
                                {errors.amount && <p className="text-red-600 text-sm mt-1">{errors.amount.message as string}</p>}
                            </div>
                            ...
                            {selectedOption && (
                                <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-xl border-2 border-green-200">
                                    <div className="text-sm text-gray-600 mb-1">Tahsilat Özeti</div>
                                    <div className="grid grid-cols-2 gap-4 mt-3">
                                        <div>
                                            <div className="text-xs text-gray-600">Müşteriden Tahsil:</div>
                                            <div className="text-lg font-bold text-gray-900">
                                                {selectedOption.gross_amount.toFixed(2)} ₺
                                            </div>
                                        </div>
                                        <div>
                                            <div className="text-xs text-gray-600">Komisyon:</div>
                                    ...
                                    <div>
                                        <div className="text-xs text-gray-600">Hesabınıza Geçecek:</div>
                ...
                <div className="space-y-6">
                    <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
                        <h3 className="text-sm font-bold text-blue-900 mb-2">Bilgi</h3>
                    ...
                    {selectedOption && (
                        <div className="bg-purple-50 border border-purple-100 rounded-xl p-4">
                            <h3 className="text-sm font-bold text-purple-900 mb-2">Komisyon Detayı</h3>
