...
import { CreateInvoiceData, UpdateInvoiceData } from '../types/invoice';
          ...
          <div className="w-full max-w-md">
            <dl className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <dd className="text-sm text-gray-900">{formatCurrency(invoice.totalTax)}</dd>
              </div>
              <div className="flex justify-between border-t border-gray-200 pt-2">
                <dt className="text-base font-medium text-gray-900">Genel Toplam</dt>
                <dd className="text-base font-medium text-gray-900">{formatCurrency(invoice.grandTotal)}</dd>
              </div>
            </dl>
          </div>
        </div>
