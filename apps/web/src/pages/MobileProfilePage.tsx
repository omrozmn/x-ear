...
export const MobileProfilePage: React.FC = () => {
        ...
        <>
            ...
            <div className="p-4 space-y-6">
                ...
                <div className="bg-card p-6 rounded-2xl shadow-sm border border-border flex flex-col items-center text-center">
                    ...
                    <div className="mt-2 px-3 py-1 bg-muted rounded-full text-xs font-medium text-muted-foreground">
                        {user?.role || 'Kullanıcı'}
                    </div>
                </div>
                ...
                <button data-allow-raw="true"
                    ...
                    className="w-full bg-card p-4 rounded-2xl shadow-sm border border-red-100 flex items-center justify-center gap-2 text-destructive font-medium active:bg-destructive/10 transition-colors"
                >
            ...
            <div className="p-4 bg-muted min-h-screen">
                <div className="bg-card rounded-xl shadow-sm border border-border p-4 space-y-4">
                    <div>
                        ...
                        <div className="p-3 bg-muted rounded-2xl text-sm">{user?.name}</div>
                    </div>
                    <div>
                        <label className="text-xs text-muted-foreground mb-1 block">E-posta</label>
                        <div className="p-3 bg-muted rounded-2xl text-sm flex items-center gap-2">
    ...
    const renderSecurityView = () => (
        <>
            ...
            <div className="p-4 bg-muted min-h-screen">
                <div className="bg-card rounded-xl shadow-sm border border-border p-4 space-y-4">
                    <h3 className="font-medium text-foreground border-b border-border pb-2">Şifre Değiştir</h3>
                    {/* Simple inputs just for visual placeholder */}
                    <div>
                        <input data-allow-raw="true" type="password" placeholder="Mevcut Şifre" className="w-full p-3 bg-muted rounded-2xl text-sm border-none focus:ring-2 focus:ring-primary-500" />
                    </div>
                    <div>
                        <input data-allow-raw="true" type="password" placeholder="Yeni Şifre" className="w-full p-3 bg-muted rounded-2xl text-sm border-none focus:ring-2 focus:ring-primary-500" />
                    </div>
                    <div>
                        <input data-allow-raw="true" type="password" placeholder="Yeni Şifre (Tekrar)" className="w-full p-3 bg-muted rounded-2xl text-sm border-none focus:ring-2 focus:ring-primary-500" />
                    </div>
