...
class SimpleCommunicationSync {
  ...
  private async syncMessagesFromServer(): Promise<void> {
    // Messages API endpoint not available yet - skip syncing messages
    // TODO: Implement when communicationsListMessages endpoint is added
    console.log('Messages sync skipped - API endpoint not available');
  }
