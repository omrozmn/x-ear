...
import type { UpdateSettingsBody } from ".././schemas";
...
export const patchSettings = () => {
  return customInstance<void>({ url: `/api/settings`, method: "PATCH" });
};

export const getPatchSettingsMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type PatchSettingsMutationResult = NonNullable<
  Awaited<ReturnType<typeof patchSettings>>
>;
