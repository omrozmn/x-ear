...
import type { ActivityLogsCreateActivityLogBody } from ".././schemas";
...
export const getActivityLogsCreateActivityLogMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
...
export type ActivityLogsCreateActivityLogMutationResult = NonNullable<
  Awaited<ReturnType<typeof activityLogsCreateActivityLog>>
>;
export type ActivityLogsCreateActivityLogMutationBody =
 ...
 * @summary Create a new activity log entry (legacy endpoint)
 */
export const useActivityLogsCreateActivityLog = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
> => {
  const mutationOptions =
    getActivityLogsCreateActivityLogMutationOptions(options);
