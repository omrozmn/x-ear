...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getPatientSubresourcesGetPatientDevicesQueryKey(patientId);
   ...
   return  { queryKey, queryFn, enabled: !!(patientId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof patientSubresourcesGetPatientDevices>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}
