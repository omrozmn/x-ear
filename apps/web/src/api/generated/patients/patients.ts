...
export const getPatientSubresourcesGetPatientDevicesQueryKey = (
  patientId?: string,
) => {
  return [`/api/patients/${patientId}/devices`] as const;
};

export const getPatientSubresourcesGetPatientDevicesQueryOptions = <
  TData = Awaited<ReturnType<typeof patientSubresourcesGetPatientDevices>>,
  TError = unknown,
>(
  patientId: string,
  options?: {
  ...
  const queryKey =
    ...
    getPatientSubresourcesGetPatientDevicesQueryKey(patientId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof patientSubresourcesGetPatientDevices>>
  > = ({ signal }) => patientSubresourcesGetPatientDevices(patientId, signal);
...
export type PatientSubresourcesGetPatientDevicesQueryResult = NonNullable<
  Awaited<ReturnType<typeof patientSubresourcesGetPatientDevices>>
>;
...
export function usePatientSubresourcesGetPatientDevices<
  TData = Awaited<ReturnType<typeof patientSubresourcesGetPatientDevices>>,
  TError = unknown,
>(
  patientId: string,
  ...
  const queryOptions = getPatientSubresourcesGetPatientDevicesQueryOptions(
    patientId,
    options,
  );
...
export const getPatientSubresourcesGetPatientAppointmentsQueryKey = (
  patientId?: string,
) => {
  return [`/api/patients/${patientId}/appointments`] as const;
};

export const getPatientSubresourcesGetPatientAppointmentsQueryOptions = <
  TData = Awaited<ReturnType<typeof patientSubresourcesGetPatientAppointments>>,
  TError = unknown,
>(
  patientId: string,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ??
    getPatientSubresourcesGetPatientAppointmentsQueryKey(patientId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof patientSubresourcesGetPatientAppointments>>
  > = ({ signal }) =>
    patientSubresourcesGetPatientAppointments(patientId, signal);
...
export type PatientSubresourcesGetPatientAppointmentsQueryResult = NonNullable<
  Awaited<ReturnType<typeof patientSubresourcesGetPatientAppointments>>
>;
...
export function usePatientSubresourcesGetPatientAppointments<
  TData = Awaited<ReturnType<typeof patientSubresourcesGetPatientAppointments>>,
  TError = unknown,
>(
  patientId: string,
  ...
  const queryOptions = getPatientSubresourcesGetPatientAppointmentsQueryOptions(
    patientId,
    options,
  );
