 ...
 */
export const notificationsGetNotifications = (signal?: AbortSignal) => {
...
>(options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getNotificationsGetNotificationsQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof notificationsGetNotifications>>
  > = ({ signal }) => notificationsGetNotifications(signal);
