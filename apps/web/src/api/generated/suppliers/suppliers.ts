...
export const getSuppliersUpdateSupplierMutationOptions = <TError = ErrorResponse,
...
const {mutation: mutationOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SuppliersUpdateSupplierMutationError = ErrorResponse

    /**
 * @summary Update supplier details
 */
export const useSuppliersUpdateSupplier = <TError = ErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof suppliersUpdateSupplier>>, TError,{supplierId: string;data: SuppliersUpdateSupplierBody}, TContext>, }
 , queryClient?: QueryClient): UseMutationResult<
