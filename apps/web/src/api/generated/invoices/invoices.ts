...
export const getInvoicesActionsServeInvoicePdfQueryKey = (
  invoiceId?: string,
) => {
  return [`/api/invoices/${invoiceId}/pdf`] as const;
};

export const getInvoicesActionsServeInvoicePdfQueryOptions = <
  TData = Awaited<ReturnType<typeof invoicesActionsServeInvoicePdf>>,
  TError = ErrorResponse | ErrorResponse,
>(
  invoiceId: string,
  options?: {
  ...
  const queryKey =
    ...
    getInvoicesActionsServeInvoicePdfQueryKey(invoiceId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof invoicesActionsServeInvoicePdf>>
  > = ({ signal }) => invoicesActionsServeInvoicePdf(invoiceId, signal);
...
export type InvoicesActionsServeInvoicePdfQueryResult = NonNullable<
  Awaited<ReturnType<typeof invoicesActionsServeInvoicePdf>>
>;
export type InvoicesActionsServeInvoicePdfQueryError =
  | ErrorResponse
  | ErrorResponse;
...
export function useInvoicesActionsServeInvoicePdf<
  TData = Awaited<ReturnType<typeof invoicesActionsServeInvoicePdf>>,
  TError = ErrorResponse | ErrorResponse,
>(
  invoiceId: string,
  ...
  const queryOptions = getInvoicesActionsServeInvoicePdfQueryOptions(
    invoiceId,
    options,
  );
...
export const getInvoicesSendInvoiceToGibMockMutationOptions = <
  TError = ErrorResponse | ErrorResponse,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type InvoicesSendInvoiceToGibMockMutationResult = NonNullable<
  Awaited<ReturnType<typeof invoicesSendInvoiceToGibMock>>
>;

export type InvoicesSendInvoiceToGibMockMutationError =
  | ErrorResponse
  | ErrorResponse;
 ...
 * @summary Send invoice to GİB
 */
export const useInvoicesSendInvoiceToGibMock = <
  TError = ErrorResponse | ErrorResponse,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
> => {
  const mutationOptions =
    getInvoicesSendInvoiceToGibMockMutationOptions(options);
...
export const invoicesSubmitEfaturaManual = (
  ...
  return customInstance<void>({
    url: `/api/invoices/efatura/submit`,
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
export const getInvoicesSubmitEfaturaManualMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type InvoicesSubmitEfaturaManualMutationResult = NonNullable<
  Awaited<ReturnType<typeof invoicesSubmitEfaturaManual>>
>;
export type InvoicesSubmitEfaturaManualMutationBody =
  InvoicesSubmitEfaturaManualBody;
 ...
 * @summary Mock endpoint for manual e-fatura submission.
 */
export const useInvoicesSubmitEfaturaManual = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
> => {
  const mutationOptions =
    getInvoicesSubmitEfaturaManualMutationOptions(options);
