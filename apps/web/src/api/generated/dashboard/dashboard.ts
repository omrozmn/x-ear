...
export const getDashboardGetDashboardQueryOptions = <TData = Awaited<ReturnType<typeof dashboardGetDashboard>>, TError = ErrorResponse>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof dashboardGetDashboard>>, TError, TData>>, }
) => {
...
export type DashboardGetDashboardQueryError = ErrorResponse


export function useDashboardGetDashboard<TData = Awaited<ReturnType<typeof dashboardGetDashboard>>, TError = ErrorResponse>(
