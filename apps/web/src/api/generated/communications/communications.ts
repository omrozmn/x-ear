...
export const getCommunicationsGetMessagesQueryOptions = <
  TData = Awaited<ReturnType<typeof communicationsGetMessages>>,
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getCommunicationsGetMessagesQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof communicationsGetMessages>>
  > = ({ signal }) => communicationsGetMessages(params, signal);
...
export type CommunicationsGetMessagesQueryResult = NonNullable<
  Awaited<ReturnType<typeof communicationsGetMessages>>
>;
export type CommunicationsGetMessagesQueryError =
  | ErrorResponse
  | ErrorResponse
  | ErrorResponse;
...
export function useCommunicationsGetMessages<
  TData = Awaited<ReturnType<typeof communicationsGetMessages>>,
  TError = ErrorResponse | ErrorResponse | ErrorResponse,
>(
  params?: CommunicationsGetMessagesParams,
  ...
  const queryOptions = getCommunicationsGetMessagesQueryOptions(
    params,
    options,
  );
