 ...
 */
export const permissionsGetPermissions = (
...
export const getPermissionsGetPermissionsQueryKey = () => {
    return [
    `/api/permissions`
    ] as const;
    }
...
export const getPermissionsGetPermissionsQueryOptions = <TData = Awaited<ReturnType<typeof permissionsGetPermissions>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof permissionsGetPermissions>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getPermissionsGetPermissionsQueryKey();

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof permissionsGetPermissions>>> = ({ signal }) => permissionsGetPermissions(signal);

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof permissionsGetPermissions>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}

export type PermissionsGetPermissionsQueryResult = NonNullable<Awaited<ReturnType<typeof permissionsGetPermissions>>>
export type PermissionsGetPermissionsQueryError = unknown


export function usePermissionsGetPermissions<TData = Awaited<ReturnType<typeof permissionsGetPermissions>>, TError = unknown>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof permissionsGetPermissions>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof permissionsGetPermissions>>,
          TError,
          Awaited<ReturnType<typeof permissionsGetPermissions>>
        > , 'initialData'
      >, }
...
export function usePermissionsGetPermissions<TData = Awaited<ReturnType<typeof permissionsGetPermissions>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof permissionsGetPermissions>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData> }
/**
 * @summary List all permissions, grouped by category (Admin)
...
export function usePermissionsGetPermissions<TData = Awaited<ReturnType<typeof permissionsGetPermissions>>, TError = unknown>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getPermissionsGetPermissionsQueryOptions(options)
