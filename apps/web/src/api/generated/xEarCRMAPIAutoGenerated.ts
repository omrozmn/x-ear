 ...
 */
const inventoryUpdateInventoryItem = <TData = AxiosResponse<InventoryUpdateInventoryItem200>>(
    itemId: string,
 ...
 */
const inventoryGetBrands = <TData = AxiosResponse<InventoryGetBrands200>>(
     options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.get(
 ...
 */
const inventoryCreateBrand = <TData = AxiosResponse<InventoryCreateBrand201>>(
 ...
 */
const invoicesCreateInvoice = <TData = AxiosResponse<InvoicesCreateInvoice201>>(
 ...
 */
const invoicesBulkUploadInvoices = <TData = AxiosResponse<InvoicesBulkUploadInvoices200>>(
 ...
 */
const invoicesDeleteInvoice = <TData = AxiosResponse<InvoicesDeleteInvoice200>>(
    invoiceId: string, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.delete(
      `/api/invoices/${invoiceId}`,options
 ...
 */
const patientsGetPatient = <TData = AxiosResponse<Patient>>(
 ...
 */
const patientsUpdatePatient = <TData = AxiosResponse<Patient>>(
    patientId: string,
 ...
 */
const patientsGetPatientDevices = <TData = AxiosResponse<PatientsGetPatientDevices200>>(
    patientId: string, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.get(
 ...
 */
const salesCreateSaleInvoice = <TData = AxiosResponse<SalesCreateSaleInvoice201>>(
    saleId: string,
 ...
 */
const suppliersUpdateSupplier = <TData = AxiosResponse<Supplier>>(
    supplierId: string,
 ...
 */
const suppliersBulkUploadSuppliers = <TData = AxiosResponse<void>>(
 ...
 */
const suppliersGetSupplierInvoices = <TData = AxiosResponse<SuppliersGetSupplierInvoices200>>(
    supplierId: string,
 ...
 */
const suppliersGetSuggestedSuppliers = <TData = AxiosResponse<SuppliersGetSuggestedSuppliers200>>(
     options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.get(
 ...
 */
const suppliersAcceptSuggestedSupplier = <TData = AxiosResponse<SuppliersAcceptSuggestedSupplier200 | SuppliersAcceptSuggestedSupplier201>>(
 ...
 */
const suppliersRejectSuggestedSupplier = <TData = AxiosResponse<SuppliersRejectSuggestedSupplier200>>(
    suggestedId: string, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.delete(
 ...
 */
const birfaturaSyncInvoices = <TData = AxiosResponse<BirfaturaSyncInvoices200>>(
...
return {appointmentsGetAppointments,appointmentsCreateAppointment,communicationsListMessages,communicationsListTemplates,communicationsCreateTemplate,communicationsGetTemplate,communicationsUpdateTemplate,communicationsDeleteTemplate,appointmentsDeleteAppointment,appointmentsCancelAppointment,appointmentsCompleteAppointment,appointmentsRescheduleAppointment,appointmentsGetAvailability,appointmentsListAppointments,automationTriggerBackup,automationGetAutomationLogs,automationTriggerSgkProcessing,automationGetAutomationStatus,campaignsCreateCampaign,dashboardGetDashboardData,campaignsSendCampaign,registrationGetTurnstileConfig,dashboardPatientTrends,dashboardRevenueTrends,dashboardGetKpis,dashboardRecentActivity,devicesGetDevices,devicesCreateDevice,devicesDeleteDevice,devicesUpdateDeviceStock,devicesGetDeviceBrands,devicesCreateDeviceBrand,devicesGetDeviceCategories,devicesCreateDeviceCategory,devicesGetLowStockDevices,healthCheck,inventoryGetInventoryItems,inventoryCreateInventoryItem,inventoryGetInventoryItem,inventoryDeleteInventoryItem,inventoryUpdateInventoryItem,inventoryGetInventoryActivities,inventoryAssignToPatient,inventoryAddSerialNumbers,inventoryGetLowStockItems,inventoryGetInventoryStats,inventoryGetCategories,inventoryCreateCategory,inventoryGetBrands,inventoryCreateBrand,invoicesCreateInvoice,invoicesBulkUploadInvoices,invoicesGetInvoice,invoicesDeleteInvoice,invoicesGenerateInvoicePdf,invoicesSendToGib,notificationsListNotifications,notificationsDeleteNotification,notificationsMarkNotificationRead,notificationsNotificationStats,sgkProcessOcr,serveOpenapiYaml,patientsGetPatients,patientsCreatePatient,patientsGetPatient,patientsUpdatePatient,patientsDeletePatient,salesAssignDevicesExtended,patientsGetPatientDevices,patientSubresourcesCreatePatientEreceipt,patientSubresourcesDeletePatientEreceipt,patientSubresourcesAddPatientHearingTest,patientSubresourcesDeletePatientHearingTest,patientSubresourcesCreatePatientNote,patientSubresourcesDeletePatientNote,paymentsGetPatientPromissoryNotes,salesGetPatientSales,sgkGetPatientSgkDocuments,timelineGetPatientTimeline,timelineAddTimelineEvent,timelineDeleteTimelineEvent,timelineLogPatientActivity,patientsBulkUploadPatients,patientsExportPatientsCsv,patientsSearchPatients,salesPricingPreview,suppliersDeleteProductSupplier,suppliersAddProductSupplier,paymentsCreatePromissoryNotes,paymentsUpdatePromissoryNote,paymentsCollectPromissoryNote,registrationRegisterPhone,reportsReportAppointments,reportsReportCampaigns,reportsReportFinancial,reportsReportOverview,reportsReportPatients,reportsReportRevenue,salesListSales,salesCreateSale,salesGetSale,salesUpdateSale,salesDeleteSale,salesCreateSalePaymentPlan,paymentsGetSalePromissoryNotes,salesCreateSaleInvoice,salesGetSaleInvoice,salesGenerateSaleInvoicePdf,updateSettings,sgkUploadSgkDocument,sgkDeleteSgkDocument,smsMonitoring,suppliersGetSuppliers,suppliersCreateSupplier,suppliersDeleteSupplier,suppliersUpdateSupplier,suppliersGetSupplierProducts,suppliersGetSupplierStats,suppliersBulkUploadSuppliers,suppliersGetSupplierInvoices,suppliersGetSuggestedSuppliers,suppliersAcceptSuggestedSupplier,suppliersRejectSuggestedSupplier,birfaturaSyncInvoices,registrationVerifyRegistrationOtp,usersListUsers,usersCreateUser,usersGetUser,usersUpdateUser,usersDeleteUser,usersGetCurrentUser,ocrExtractEntities,ocrExtractPatientName,ocrHealthCheck,ocrInitDatabase,ocrInitializeNlpEndpoint,ocrProcessDocument,ocrCalculateSimilarity,serveSwaggerUi}};
...
export type InventoryUpdateInventoryItemResult = AxiosResponse<InventoryUpdateInventoryItem200>
...
export type InventoryGetBrandsResult = AxiosResponse<InventoryGetBrands200>
export type InventoryCreateBrandResult = AxiosResponse<InventoryCreateBrand201>
export type InvoicesCreateInvoiceResult = AxiosResponse<InvoicesCreateInvoice201>
export type InvoicesBulkUploadInvoicesResult = AxiosResponse<InvoicesBulkUploadInvoices200>
export type InvoicesGetInvoiceResult = AxiosResponse<InvoicesGetInvoice200>
export type InvoicesDeleteInvoiceResult = AxiosResponse<InvoicesDeleteInvoice200>
...
export type PatientsGetPatientResult = AxiosResponse<Patient>
export type PatientsUpdatePatientResult = AxiosResponse<Patient>
...
export type SalesCreateSaleInvoiceResult = AxiosResponse<SalesCreateSaleInvoice201>
...
export type SuppliersUpdateSupplierResult = AxiosResponse<Supplier>
...
export type SuppliersBulkUploadSuppliersResult = AxiosResponse<void>
export type SuppliersGetSupplierInvoicesResult = AxiosResponse<SuppliersGetSupplierInvoices200>
export type SuppliersGetSuggestedSuppliersResult = AxiosResponse<SuppliersGetSuggestedSuppliers200>
export type SuppliersAcceptSuggestedSupplierResult = AxiosResponse<SuppliersAcceptSuggestedSupplier200 | SuppliersAcceptSuggestedSupplier201>
export type SuppliersRejectSuggestedSupplierResult = AxiosResponse<SuppliersRejectSuggestedSupplier200>
export type BirfaturaSyncInvoicesResult = AxiosResponse<BirfaturaSyncInvoices200>
