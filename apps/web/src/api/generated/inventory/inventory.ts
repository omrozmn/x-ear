...
export const inventoryGetInventoryMovements = (
  ...
  return customInstance<void>({
    url: `/api/inventory/${itemId}/movements`,
    method: "GET",
    signal,
  });
};
...
export const getInventoryGetInventoryMovementsQueryKey = (itemId?: string) => {
  return [`/api/inventory/${itemId}/movements`] as const;
};

export const getInventoryGetInventoryMovementsQueryOptions = <
  TData = Awaited<ReturnType<typeof inventoryGetInventoryMovements>>,
  TError = unknown,
>(
  itemId: string,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getInventoryGetInventoryMovementsQueryKey(itemId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof inventoryGetInventoryMovements>>
  > = ({ signal }) => inventoryGetInventoryMovements(itemId, signal);
...
export type InventoryGetInventoryMovementsQueryResult = NonNullable<
  Awaited<ReturnType<typeof inventoryGetInventoryMovements>>
>;
...
export function useInventoryGetInventoryMovements<
  TData = Awaited<ReturnType<typeof inventoryGetInventoryMovements>>,
  TError = unknown,
>(
  itemId: string,
  ...
  const queryOptions = getInventoryGetInventoryMovementsQueryOptions(
    itemId,
    options,
  );
