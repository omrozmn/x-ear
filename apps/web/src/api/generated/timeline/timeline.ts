 ...
 */
export const timelineGetTimeline = (signal?: AbortSignal) => {
  return customInstance<void>({ url: `/api/timeline`, method: "GET", signal });
};
...
export const getTimelineGetTimelineQueryOptions = <
  TData = Awaited<ReturnType<typeof timelineGetTimeline>>,
  TError = unknown,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof timelineGetTimeline>>
  > = ({ signal }) => timelineGetTimeline(signal);
...
export type TimelineGetTimelineQueryResult = NonNullable<
  Awaited<ReturnType<typeof timelineGetTimeline>>
>;
...
export function useTimelineGetTimeline<
  TData = Awaited<ReturnType<typeof timelineGetTimeline>>,
  TError = unknown,
>(options?: {
  query?: UseQueryOptions<
