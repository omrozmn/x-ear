...
export const getInvoicesGetSaleInvoiceQueryOptions = <TData = Awaited<ReturnType<typeof invoicesGetSaleInvoice>>, TError = ErrorResponse>(saleId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof invoicesGetSaleInvoice>>, TError, TData>>, }
) => {
...
export type InvoicesGetSaleInvoiceQueryError = ErrorResponse


export function useInvoicesGetSaleInvoice<TData = Awaited<ReturnType<typeof invoicesGetSaleInvoice>>, TError = ErrorResponse>(
...
export const getInvoicesGenerateSaleInvoicePdfQueryOptions = <TData = Awaited<ReturnType<typeof invoicesGenerateSaleInvoicePdf>>, TError = ErrorResponse>(saleId: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof invoicesGenerateSaleInvoicePdf>>, TError, TData>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getInvoicesGenerateSaleInvoicePdfQueryKey(saleId);
   ...
   return  { queryKey, queryFn, enabled: !!(saleId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof invoicesGenerateSaleInvoicePdf>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}
...
export type InvoicesGenerateSaleInvoicePdfQueryError = ErrorResponse


export function useInvoicesGenerateSaleInvoicePdf<TData = Awaited<ReturnType<typeof invoicesGenerateSaleInvoicePdf>>, TError = ErrorResponse>(
