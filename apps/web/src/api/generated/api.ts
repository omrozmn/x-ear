 ...
 */
const salesGetPatientSales = <TData = AxiosResponse<Sale[]>>(
    patientId: string, options?: AxiosRequestConfig
 ): Promise<TData> => {
    return axios.get(
...
export type SalesGetPatientSalesResult = AxiosResponse<Sale[]>
