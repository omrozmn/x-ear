...
export const getTenantUsersInviteTenantUserMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
...
export type TenantUsersInviteTenantUserMutationResult = NonNullable<
  Awaited<ReturnType<typeof tenantUsersInviteTenantUser>>
>;
export type TenantUsersInviteTenantUserMutationBody =
  TenantUsersInviteTenantUserBody;
 ...
 * @summary Invite/Create tenant user
 */
export const useTenantUsersInviteTenantUser = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
> => {
  const mutationOptions =
    getTenantUsersInviteTenantUserMutationOptions(options);
