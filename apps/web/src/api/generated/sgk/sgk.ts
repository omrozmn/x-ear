 ...
 */
export const sgkGetSgkDocuments = (
...
export const getSgkGetSgkDocumentsQueryKey = () => {
    return [
    `/api/sgk/documents`
    ] as const;
    }
...
export const getSgkGetSgkDocumentsQueryOptions = <TData = Awaited<ReturnType<typeof sgkGetSgkDocuments>>, TError = unknown>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof sgkGetSgkDocuments>>, TError, TData>>, }
) => {

const {query: queryOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getSgkGetSgkDocumentsQueryKey();

  

    const queryFn: QueryFunction<Awaited<ReturnType<typeof sgkGetSgkDocuments>>> = ({ signal }) => sgkGetSgkDocuments(signal);

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof sgkGetSgkDocuments>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}

export type SgkGetSgkDocumentsQueryResult = NonNullable<Awaited<ReturnType<typeof sgkGetSgkDocuments>>>
export type SgkGetSgkDocumentsQueryError = unknown


export function useSgkGetSgkDocuments<TData = Awaited<ReturnType<typeof sgkGetSgkDocuments>>, TError = unknown>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof sgkGetSgkDocuments>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof sgkGetSgkDocuments>>,
          TError,
          Awaited<ReturnType<typeof sgkGetSgkDocuments>>
        > , 'initialData'
      >, }
...
export function useSgkGetSgkDocuments<TData = Awaited<ReturnType<typeof sgkGetSgkDocuments>>, TError = unknown>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof sgkGetSgkDocuments>>, TError, TData>>, }
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData> }
/**
 * @summary GET /api/sgk/documents
...
export function useSgkGetSgkDocuments<TData = Awaited<ReturnType<typeof sgkGetSgkDocuments>>, TError = unknown>(
 ...
 , queryClient?: QueryClient 
  ...
  const queryOptions = getSgkGetSgkDocumentsQueryOptions(options)
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getSgkDownloadPatientFormQueryKey(receiptId);
   ...
   return  { queryKey, queryFn, enabled: !!(receiptId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof sgkDownloadPatientForm>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}
