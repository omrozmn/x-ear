...
export const sgkUpdateWorkflowStatus = (
  ...
  return customInstance<void>({
    url: `/api/sgk/workflows/${workflowId}/status`,
    method: "PUT",
    headers: { "Content-Type": "application/json" },
...
export const getSgkUpdateWorkflowStatusMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type SgkUpdateWorkflowStatusMutationResult = NonNullable<
  Awaited<ReturnType<typeof sgkUpdateWorkflowStatus>>
>;
 ...
 * @summary Mock endpoint to update workflow status.
 */
export const useSgkUpdateWorkflowStatus = <
  TError = unknown,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const sgkDownloadPatientForm = (
  ...
  return customInstance<void>({
    url: `/api/sgk/e-receipts/${receiptId}/download-patient-form`,
    method: "GET",
    signal,
  });
};
...
export const getSgkDownloadPatientFormQueryKey = (receiptId?: string) => {
  return [`/api/sgk/e-receipts/${receiptId}/download-patient-form`] as const;
};

export const getSgkDownloadPatientFormQueryOptions = <
  TData = Awaited<ReturnType<typeof sgkDownloadPatientForm>>,
  TError = unknown,
>(
  receiptId: string,
  options?: {
  ...
  const queryKey =
    queryOptions?.queryKey ?? getSgkDownloadPatientFormQueryKey(receiptId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof sgkDownloadPatientForm>>
  > = ({ signal }) => sgkDownloadPatientForm(receiptId, signal);
...
export type SgkDownloadPatientFormQueryResult = NonNullable<
  Awaited<ReturnType<typeof sgkDownloadPatientForm>>
>;
...
export function useSgkDownloadPatientForm<
  TData = Awaited<ReturnType<typeof sgkDownloadPatientForm>>,
  TError = unknown,
>(
  receiptId: string,
  ...
  const queryOptions = getSgkDownloadPatientFormQueryOptions(
    receiptId,
    options,
  );
