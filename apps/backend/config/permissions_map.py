...
ENDPOINT_PERMISSIONS = {
    ...
    # =========================================================================
    ('GET', '/appointments'): 'patients.view',
    ('POST', '/appointments'): 'patients.edit',
    ('GET', '/appointments/<appointment_id>'): 'patients.view',
    ('PUT', '/appointments/<appointment_id>'): 'patients.edit',
    ('PATCH', '/appointments/<appointment_id>'): 'patients.edit',
    ('DELETE', '/appointments/<appointment_id>'): 'patients.edit',
    ('POST', '/appointments/<appointment_id>/reschedule'): 'patients.edit',
    ('POST', '/appointments/<appointment_id>/cancel'): 'patients.edit',
    ('POST', '/appointments/<appointment_id>/complete'): 'patients.edit',
    ('GET', '/appointments/availability'): 'patients.view',
    ('GET', '/appointments/list'): 'patients.view',
