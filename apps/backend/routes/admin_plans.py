...
def create_plan(ctx):
    ...
    try:
        ...
        return success_response(data={'plan': plan.to_dict()}, status_code=201)
...
def get_plan(ctx, plan_id):
    ...
    try:
        ...
        return success_response(data={'plan': plan.to_dict(include_relationships=True)})
