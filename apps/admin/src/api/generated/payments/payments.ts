...
export const createPaymentRecords = (
 ...
 signal?: AbortSignal
      ...
      return adminApi<ResponseEnvelopePaymentRecordRead>(
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListPartyPaymentRecordsQueryKey(partyId,params);
   ...
   return  { queryKey, queryFn, enabled: !!(partyId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listPartyPaymentRecords>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}
...
export const listPartyPromissoryNotes = (
 ...
 signal?: AbortSignal
      ...
      return adminApi<ResponseEnvelopeListPromissoryNoteRead>(
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListPartyPromissoryNotesQueryKey(partyId,params);
   ...
   return  { queryKey, queryFn, enabled: !!(partyId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listPartyPromissoryNotes>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}
...
export const updatePromissoryNote = (
    ...
    promissoryNoteUpdate: PromissoryNoteUpdate,
      ...
      return adminApi<ResponseEnvelopePromissoryNoteRead>(
...
export const createPromissoryNoteCollect = (
 ...
 signal?: AbortSignal
      ...
      return adminApi<ResponseEnvelopePromissoryNoteCollectionResponse>(
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListSalePromissoryNotesQueryKey(saleId);
   ...
   return  { queryKey, queryFn, enabled: !!(saleId), ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listSalePromissoryNotes>>, TError, TData> & { queryKey: DataTag<QueryKey, TData> }
}
