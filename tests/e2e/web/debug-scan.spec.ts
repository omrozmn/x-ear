...
const resultsFile = 'test-results/web-scan-data.json';
...
test.describe('Debug Scan: Web App Routes (Phase 2.1)', () => {
  ...
  test('generate final report', async () => {
    ...
    console.log(`   Total: ${results.length}/${webRoutes.length} routes scanned`);
