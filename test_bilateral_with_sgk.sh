...
# Test bilateral sale with SGK scheme
BASE_URL="http://localhost:5003"
TENANT_ID="95625589-a4ad-41ff-a99e-4955943bb421"

echo "=== Testing Bilateral Sale with SGK ==="
echo ""
...
echo "1. Creating bilateral sale with SGK (over18_retired = 4239.20 per ear)..."
IDEMPOTENCY_KEY="test-bilateral-sgk-$(date +%s)-$RANDOM"
